    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <a href="<?= base_url; ?>/jabatan/lihatlaporan" class="btn float-right btn-xs btn btn-warning" target="_blank">Cetak Data Jabatan</a>
                        ...
                        <div class="col-lg-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a class="btn btn-outline-danger" href="<?= base_url; ?>/jabatan">Reset</a>
                                </div>
                            </div>
                        </div>
                    </div>
