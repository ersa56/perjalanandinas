            ...
            <form role="form" action="<?= base_url; ?>/anggota/simpanAnggota" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="masukkan ID..." name="id_anggota_dewan">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="masukkan No Anggota..." name="no_anggota_dewan">
                    </div>
                    <div class="form-group">
