            ...
            <form role="form" action="<?= base_url; ?>/anggota/updateAnggota" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="masukkan penerbit buku..." name="id_anggota_dewan" value="<?= $data['tb_anggota_dewan']['id_anggota_dewan']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Nama Anggota Dewan</label>
                        <select class="form-control" name="nama_jabatan_id">
                            <option value="">Pilih</option>
                            <?php foreach ($data['tb_jabatan'] as $row) : ?>
                                <option value="<?= $row['id']; ?>" <?php if ($data['tb_anggota_dewan']['nama_jabatan_id'] == $row['id']) {
                                                                        echo "selected";
                                                                    } ?>><?= $row['nama_jabatan']; ?>
                                </option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group">
                        <label>NIP</label>
                        <input type="number" class="form-control" placeholder="masukkan harga buku..." name="nip" value="<?= $data['tb_anggota_dewan']['nip']; ?>">
                    </div>
                    <div class="form-group">
                        <label>No Anggota Dewan</label>
                        <input type="number" class="form-control" placeholder="masukkan harga buku..." name="no_anggota_dewan" value="<?= $data['tb_anggota_dewan']['no_anggota_dewan']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Umur</label>
                        <input type="number" class="form-control" placeholder="masukkan harga buku..." name="umur" value="<?= $data['tb_anggota_dewan']['umur']; ?>">
                    </div>
                </div>
