                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jangka_waktu">
                            <?php
                            $selectedDuration = $data['tb_sppd']['jangka_waktu']; // Ganti dengan variabel atau data yang sesuai di halaman edit
                            ?>
                            <option value="1 Hari" <?php echo ($selectedDuration == '1 Hari') ? 'selected' : ''; ?>>1 Hari</option>
                            <option value="2 Hari" <?php echo ($selectedDuration == '2 Hari') ? 'selected' : ''; ?>>2 Hari</option>
                            <?php
                            for ($i = 3; $i <= 7; $i++) {
                                $optionValue = $i . ' Hari';
                                echo "<option value='$optionValue' " . (($selectedDuration == $optionValue) ? 'selected' : '') . ">$optionValue</option>";
                            }
                            ?>
                        </select>
                    </div>
