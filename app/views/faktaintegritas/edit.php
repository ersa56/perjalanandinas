                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">File saat ini: <?= $data['tb_fakta_integritas']['fileupload']; ?></small>
                        </div>

                        <!-- Tambahkan ini untuk opsi pemilihan file baru -->
                        <div class="form-group">
                            <label for="fileupload">Masukkan File Ulang</label>
                            <input type="file" class="form-control" id="fileupload" name="new_fileupload">
                        </div>
                    </div>
                </div>
                <!-- /.card-body -->
